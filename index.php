...
<body>
    ...
    <header class="header">
        ...
        <section class="flex">
            ...
            <a href="#home" class="logo"><span>E</span>lf Bar.</a>
            ...
            <div class="icons">
                ...
                <a href="admin_login.php" > <div id="admin-btn" class="fa-brands fa-adn" ></div></a>
        ...
        <section class="home" id="home">
            ...
            <div class="slide-container">
                ...
                <div class="slide">
                    ...
                    <div class="content">
                        <h3>Elf Bar Cherry Lemon Peach</h3>
                        <div class="fas fa-angle-left" onclick="prev()"></div>
                        <div class="fas fa-angle-right" onclick="next()"></div>
                    </div>
                </div>
                ...
                <div class="slide">
                    ...
                    <div class="content">
                        <h3>Elf Bar Kiwi Passion Fruit</h3>
                        <div class="fas fa-angle-left" onclick="prev()"></div>
                        <div class="fas fa-angle-right" onclick="next()"></div>
                    </div>
                </div>
    ...
    <section class="about" id="about">
        ...
        <h1 class="heading">about shop</h1>

        <div class="box-container">

            <div class="box">
                <img src="images/about-1.jpg" alt="">
                <h3>Elf Bar RF350 (soon)</h3>
                <h3></h3>
                <p>Hey bro, we are planning to add NEW Elf Bar RF350 which are the rechargable pods with new awesome tastes and design.</p>
                <a href="#catalog" class="btn">our catalog</a>
            </div>

            <div class="box">
                <img src="images/about-2.jpg" alt="">
                <h3>Elf Bar 1500 LUX</h3>
                <p>Hey bro, today we added new items in our shop! It's Elf Bar LUX, more tastes and more amazing smoking pods for you!</p>
                <a href="#catalog" class="btn">our catalog</a>
            </div>
            ...
            <div class="box">
                ...
                <h3>Elf Bar 1500</h3>
                <p>Hey bro, we are open with our shop! Here you can find any Elf Bar that you want for the best price in the world!</p>
                <a href="#catalog" class="btn">our catalog</a>
            </div>
        ...
        <div class="accordion-container">
            ...
            <div class="accordion active">
                ...
                <p class="accordion-content">
                    You are picking up any Elf Bar you want, then give us your data, pay and wait for the delivery :)
                </p>
            </div>
            ...
            <div class="accordion">
                ...
                <p class="accordion-content">
                    Delivery takes from 1 to 24 hours.
                </p>
            </div>

            <div class="accordion">
                <div class="accordion-heading">
                    <span>for how long elf bar works?</span>
                    <i class="fas fa-angle-down"></i>
                </div>
                <p class="accordion-content">
                    We have only original products, so they will be working for 4-6 days!
                </p>
            </div>
    ...
    <section class="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <h3>email address</h3>
                <p>thespasik@yahoo.com</p>
            </div>

        </div>

        <div class="credit">
            &copy; made by <span>Illia Spasonov</span> | all rights reserved!
        </div>
